<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Website.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Default2" %>
                            ...
                            <div class="row">
                                ...
                                <div class="tab-content" style="padding: 0 20px; background: #E4EDFA;">
                                    <div class="tab-pane active" id="login" style="min-height: 440px; height: 440px; overflow-y: auto; overflow-x: hidden; margin-bottom: 0; padding-bottom: 0;">
                                        ...
                                        <asp:TextBox ID="txt_Captcha" runat="server" CssClass="form-control" onkeyup="ToUpper(this)" autocomplete="off" placeholder="Captcha"></asp:TextBox>
                                        <br />
