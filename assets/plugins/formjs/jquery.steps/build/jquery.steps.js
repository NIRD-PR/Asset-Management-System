...
!function (a, b) {
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                e = '<li><a href="#{0}" role="menuitem">{1}</span></a></li>',
                f = "";
    ...
    function N(b, c, d, e, f) {
        var g = q(b),
            ...
            n = a('<li role="tab"><a id="' + h + '" href="#' + k + '" aria-controls="' + j + '">' + m + "</span></a></li>");
    ...
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
            ...
            loadingTemplate: '<span class="spinner">Loading</span> #text#',
            autoFocus: !1,
            enableAllSteps: !0, //old:enableAllSteps: !1,
            enableKeyNavigation: !0,
            enablePagination: !0,
            suppressPaginationOnFocus: !0,
            enableContentCache: !0,
            enableCancelButton: !1,
            enableFinishButton: !1, //old:enableFinishButton: !0,
            preloadContent: !0, //old:preloadContent: !1,
            showFinishButtonAlways: !1,
            forceMoveForward: !1,
            saveState: !1,
            startIndex: 0,
            transitionEffect: ab.none,
            transitionEffectSpeed: 800, //old:transitionEffectSpeed: 200
            ...
            onFinished: function () { },
            onContentLoaded: function () { jQuery("#loader").hide(); },
            onInit: function () { jQuery("#loader").show(); },
            labels: {
                cancel: "Cancel",
