<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <div class="wrapper-page" onkeypress="return WebForm_FireDefaultButton(event, '<%= btn_Submit.ClientID %>')">
        ...
        <h3 class="text-center m-t-10 text-white" style="text-shadow: 1px 1px 2px black, 0 0 25px white, 0 0 5px yellow;">Sign In to <strong>NIRDPR-Payrolls</strong></h3></div>
