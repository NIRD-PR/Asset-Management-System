<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeFile="eEngineeringLogin.aspx.cs" Inherits="Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <div class="wrapper-page" onkeypress="return WebForm_FireDefaultButton(event, '<%= btn_Submit.ClientID %>')">
        ...
        <div class="panel-heading bg-img5">
        <div class="bg-overlay"></div>
        <h3 class="text-center m-t-10 text-white" style="text-shadow: 1px 1px 2px black, 0 0 25px white, 0 0 5px yellow;">Sign In to <strong>NIRDPR- e Engineering Management System</strong></h3></div>
