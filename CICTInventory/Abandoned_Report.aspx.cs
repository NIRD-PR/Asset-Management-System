...
public partial class CICTInventory_AbandonedReport : System.Web.UI.Page
{
    ...
    protected void getItems()
    {
        ...
        {
            PRResp resp = objPRIBC.getAvailableItemInventory(objPRReq);
            DataTable dt = resp.GetTable;
        ...
        else
        {
            try
            {
                ...
                PRResp resp = objPRIBC.getDisposedItemInventoryByDate(objPRReq);
                DataTable dt = resp.GetTable;
                rptr_Inventory.DataSource = dt;
                rptr_Inventory.DataBind();
