<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Inventory.master" AutoEventWireup="true" CodeFile="CICTETickets_HoldStatus.aspx.cs" Inherits="Inventory_CICTIniatedETicketsHold" %>
...
<div class="panel-heading"><h3 class="panel-title"> e-Tickets in-progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lbl_Count" runat="server" CssClass="pull-right"></asp:Label></h3></div>
