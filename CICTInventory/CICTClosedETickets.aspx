<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Inventory.master" AutoEventWireup="true" CodeFile="CICTClosedETickets.aspx.cs" Inherits="Inventory_IniatedETickets" %>
...
<script type = "text/javascript">
    function PrintHistoryPanel() {
        var panel = document.getElementById("<%=printHistory.ClientID %>");
        var printWindow = window.open('', '', 'height=400,width=800');
        printWindow.document.write('<html><head><title>NIRDPR CIT-eTicket History</title>');
...
<div class="panel-heading"><h3 class="panel-title">Closed e-Tickets &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lbl_Count" runat="server" CssClass="pull-right"></asp:Label></h3></div>
...
<table width="100%">
<tr><td align="left" width="10%"><asp:Label ID="lblPageInfo" runat="server"></asp:Label></td><td width="20%" align="right">Enter TicketNo : </td><td align="left" width="20%"><asp:TextBox ID="txt_TicketNo" runat="server" CssClass="form-control" placeholder="Ticket No"></asp:TextBox></td><td width="20%" align="left"> &nbsp; &nbsp;<asp:Button ID="btn_GetDetails" runat="server" Text="Get Ticket" CssClass="btn btn-primary" /></td>
<td width="30%" align="center">
<table width="100%" cellpadding="0" border="0" class="table-bordered">
<tr><td align="center" valign="middle"><asp:LinkButton ID="lbtnFirst" runat="server" CausesValidation="false" OnClick="lbtnFirst_Click">First</asp:LinkButton>&nbsp;</td>
                            <td align="center" valign="middle"> <asp:LinkButton ID="lbtnPrevious" runat="server" CausesValidation="false" OnClick="lbtnPrevious_Click">Previous</asp:LinkButton>&nbsp;&nbsp;</td>
...
<ItemTemplate>
<table width="100%" class="table" border="1px" style=" font-family:Tahoma; font-size:12px; font-weight:bold; line-height:18px; vertical-align:baseline; border-collapse: collapse; margin:1px ;">
<tbody><tr style="background:#FFF;"><td rowspan="2" width="5%" align="center"><%#Container.ItemIndex+1 %></td><td colspan="5" width="85%"><%#Eval("ProblemDescription")%></td><td width="10%" align="center" rowspan="2"  style="vertical-align:middle;"><asp:LinkButton ID="LinkButton3" runat="server" CommandName="History" CommandArgument='<%#Eval("TicketNo")%>'  ToolTip="Close Ticket"><i class="fa fa-history" style="font-size:X-large; color:Red;"></i></asp:LinkButton></td></tr>
<tr >
<td width="10%" align="center"><asp:LinkButton ID="LinkButton1" runat="server" CommandName="View" CommandArgument='<%#Eval("TicketNo")%>' ToolTip="View Complete Details of Ticket"><%#Eval("TicketNo")%></asp:LinkButton></td>
<td width="15%" align="center"><%#Eval("Dated")%></td>
<td width="15%" align="center" style="font-size:11px;"><%#Eval("ItemName")%></td>
<td width="30%" align="center" style="font-size:11px;"><asp:Label ID="lbl_Status" runat="server" CssClass="lblg" Text=""></asp:Label></td>
<td width="15%" align="center"><%#Eval("CDated")%></td>
</tr>
</tbody>
</table>
</ItemTemplate>
<AlternatingItemTemplate>
<table width="100%" class="table" border="1px" style=" font-family:Tahoma; font-size:12px; font-weight:bold; line-height:18px; vertical-align:baseline; border-collapse: collapse; margin:0;">
<tbody><tr style="background:#EFFBFF;"><td rowspan="2" width="5%" align="center"><%#Container.ItemIndex+1 %></td><td colspan="5" width="85%"><%#Eval("ProblemDescription")%></td><td width="10%" align="center" rowspan="2" style="vertical-align:middle;"><asp:LinkButton ID="LinkButton3" runat="server" CommandName="History" CommandArgument='<%#Eval("TicketNo")%>' ToolTip="Ticket History"><i class="fa fa-history" style="font-size:X-large; color:Red;"></i></asp:LinkButton></td></tr>
<tr style="background:#EFFBFF;">
<td width="10%" align="center"><asp:LinkButton ID="LinkButton1" runat="server" CommandName="View" CommandArgument='<%#Eval("TicketNo")%>' ToolTip="View Complete Details of Ticket"><%#Eval("TicketNo")%></asp:LinkButton></td>
<td width="15%" align="center"><%#Eval("Dated")%></td>
<td width="15%" align="center" style="font-size:11px;"><%#Eval("ItemName")%></td>
<td width="30%" align="center" style="font-size:11px;"><asp:Label ID="lbl_Status" runat="server" CssClass="lblg" Text=""></asp:Label></td>
