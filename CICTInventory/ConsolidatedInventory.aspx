<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Inventory.master" AutoEventWireup="true" CodeFile="ConsolidatedInventory.aspx.cs" Inherits="CICTInventory_ConsolidatedInventory" %>
            ...
            $('#tb1').DataTable({
                ...
                buttons: [
                    'pageLength', 'print',
                    {
                        ...
                        filename: n ,
                        title: n,
                        messageTop: 'Assets added from ' + $("#<%=stdate.ClientID%>").text() + ' to ' + $("#<%=enddate.ClientID%>").text() 
                    },
                    {
                        extend: 'pdf',
                        filename: n,
...
<div class="panel-heading"><h3 class="panel-title"> Assets Report : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="btn_print" runat="server" CssClass="btn btn-primary" OnClientClick = "return PrintPanel();"><i class="fa fa-print"></i></asp:LinkButton><asp:Label ID="lbl_Count" runat="server" CssClass="pull-right"></asp:Label></h3></div>
...
<h5> NIRDPR - Assets CICT Inventory  Details </h5>
</center>
<div class="row" style="margin: 20px">
    <strong> Assets added from <asp:Label runat="server" ID="stdate"></asp:Label> to <asp:Label runat="server" ID="enddate"></asp:Label></strong>
</div>
...
<td  width="13%"><%#Eval("ComputerNumber")%></td>
<td  width="13%"><%#Eval("DOP")%> </td>
<td  width="13%"><%#Eval("Dated")%> </td>
<td  width="6%"><asp:Label runat="server" CssClass='<%#GetColor(Eval("Status").ToString()) %>'> <%#Eval("Status")%></asp:Label></td>
