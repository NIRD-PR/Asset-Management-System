...
using System.Data;
public partial class CICTInventory_DeptDetailedITInventory : System.Web.UI.Page
{
    ...
    public void getAllInvItems()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                PRResp rm = objPRIBC.getAllItemInventory_DeptID(objPRReq);
                ...
                if (dtm.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtm.Rows.Count; i++)
                    {
                        ...
                        objPRReq.DeptID = dtm.Rows[i]["DeptID"].ToString();

                        objPRReq.Warranty = "AMC";
                        PRResp rname = objPRIBC.getAllItemInventory_ITemName_Dept_AMC(objPRReq);
                        ...
                        PRResp rw = objPRIBC.getAllItemInventory_ITemName_Dept_AMC(objPRReq);
                        ...
                        PRResp rww = objPRIBC.getAllItemInventory_ITemNameNoWarranty_Dept(objPRReq);
