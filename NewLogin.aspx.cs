    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            if (captcha == "True")
            {
                ...
                string role = ddl_roles.SelectedValue;
                if (txt_UserID.Text != "" && txt_Password.Text != "")
                {
                    ...
                    string msg1 = "You are not authorised for the role of " + ddl_roles.SelectedItem.Text;
