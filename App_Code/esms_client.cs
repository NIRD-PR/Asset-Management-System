...
namespace esms_client
{
    ...
    public class SMSHttpPostClient
    {
        ...
        public String sendSingleSMS(String username, String password, String senderid, String mobileNo, String message, String secureKey)
        {
           ...
           // System.Net.ServicePointManager.SecurityProtocol = (System.Net.SecurityProtocolType)3072; //forcing .Net framework to use TLSv1.
           /// System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.TLSv1 | SecurityProtocolType.Tls11 | SecurityProtocolType.Tls;
        ...
        {
            Stream dataStream;
            System.Net.ServicePointManager.SecurityProtocol = (System.Net.SecurityProtocolType)securityProtocol; //forcing .Net framework to use TLSv1.2
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://msdgweb.mgov.gov.in/esms/sendsmsrequest");
            request.ProtocolVersion = HttpVersion.Version10;
            request.KeepAlive = false;
            request.ServicePoint.ConnectionLimit = 1;
