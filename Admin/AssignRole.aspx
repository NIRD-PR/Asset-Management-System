<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="AssignRole.aspx.cs" Inherits="Roles" %>
...
<label>Roles </label>
<asp:ListBox ID="ddl_roles" runat="server" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox><br />
</div><br />
</div>
<div class="row">
<div class="col-xs-12" align="center"><asp:LinkButton ID="btn_Submit" runat="server" 
...
<div class="col-lg-12">
<div class="panel panel-color panel-info" style="margin-bottom:20px">
...
<td width="5%"><%#Eval("Role")%></td>
<td width="10%"><%#Eval("Mobile")%></td>
<td width="5%">
<asp:LinkButton ID="lbl_Del" runat="server" CommandName="Delete" CommandArgument='<%#Eval("UID")%>' OnClientClick= "return confirm('Are you Sure To Delete?');" ToolTip="Delete"><i class="fa fa-trash" style="font-size:large; color:Red;"></i></asp:LinkButton>
</td>
</tr>
</ItemTemplate>
    <FooterTemplate>
