...
using System.Text;
using System.IO;
public partial class CITStaff_eTicketMapping2Staff : System.Web.UI.Page
{
        ...
        try
        {
            for (int i = 0; i < gv_Tickets.Rows.Count; i++)
            {
                ...
                if (cb.Checked == true)
                {
                    ...
                    objPRReq.UEmail=gv_Tickets.Rows[i].Cells[7].Text.Trim();
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", " alert('Please Select Supporting Staff Name..!!!'); window.open('../CITSS_SelfMap/{0}','_self');", true);
                    }
                    objPRReq.Flag1 = 1;
                    ...
                    if (ddlEmp.SelectedValue.ToString() != hdn_EmpID.Value.Trim())
                    {
                        getMailService();
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", " alert('All the Selected Tickets are mapped to respective Supporting Staff Successfully..!!!'); window.open('../CITSS_SelfMap/{0}','_self');", true);
        }
        catch (Exception ex)
        {
