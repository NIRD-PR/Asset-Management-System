<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="CITStaff.master" AutoEventWireup="true" CodeFile="eTicketMapping2Staff.aspx.cs" Inherits="CITStaff_eTicketMapping2Staff" %>
...
<div class="panel-body"><asp:HiddenField ID="hdn_EmpID" runat="server" />
<div class="row">
...
<asp:GridView ID="gv_Tickets" runat="server" AutoGenerateColumns="false" 
        ...
        Width="100%" > 
                   ...
                   <asp:TemplateField  ItemStyle-Width="3%" ItemStyle-HorizontalAlign="Center" HeaderText="Check"> 
                    ...
                    <asp:BoundField DataField="Dated" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center" HeaderText="Dated" ItemStyle-Font-Size="X-Small"/>
