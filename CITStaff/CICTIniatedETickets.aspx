<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="CITStaff.master" AutoEventWireup="true" CodeFile="CICTIniatedETickets.aspx.cs" Inherits="CITStaff_IniatedETickets" %>
...
<div class="panel-heading"><h3 class="panel-title">New e-Tickets &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lbl_Count" runat="server" CssClass="pull-right"></asp:Label></h3></div>
...
<th width="10%">Ticket for</th>
<th width="15%">Ticket From</th>
<th width="10%">Available Time</th>
<th width="25%">Status</th>
<th width="7%">Comments</th>
<th width="6%">To Others</th>
<th width="7%">Close</th>
<th width="5%">Hold</th>
</tr>
</thead>
...
<td width="10%" align="center" style="font-size:11px;"><%#Eval("ItemName")%></td>
<td width="15%" style="font-size:11px;"><%#Eval("Name")%></td>
<td width="10%" style="font-size:11px;"><%#Eval("AvailableTime")%></td>
<td width="25%" align="center"><asp:Label ID="lbl_Status" runat="server" CssClass="lblg" Text=""></asp:Label></td>
<td width="7%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Comment" CommandArgument='<%#Eval("TicketNo")%>' OnClientClick= "return confirm('Are you Sure To Comment on Action?');"  ToolTip="Comment on Action"><i class="fa fa-commenting-o" style="font-size:X-large; color:Maroon;"></i></asp:LinkButton>
</td>
<td width="6%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton5" runat="server" CommandName="reAssign" CommandArgument='<%#Eval("TicketNo")%>' OnClientClick= "return confirm('Are you Sure To Re-Assign to Others?');"  ToolTip="Re-Assign to Others"><i class="fa fa-link" style="font-size:X-large; color:Blue;"></i></asp:LinkButton>
</td>
<td width="7%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton3" runat="server" CommandName="Close" CommandArgument='<%#Eval("TicketNo")%>' OnClientClick= "return confirm('Are you Sure To Close the Ticket?');"  ToolTip="Close Ticket"><i class="fa fa-times-circle-o" style="font-size:X-large; color:Black;"></i></asp:LinkButton>
</td>
<td width="5%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Hold" CommandArgument='<%#Eval("TicketNo")%>' OnClientClick= "return confirm('Are you Sure To Hold the Ticket?');"  ToolTip="Hold Ticket"><i class="fa fa-hand-paper-o" style="font-size:X-large; color:Red;"></i></asp:LinkButton>
</td>
</tr>
<tr><td width="100%" colspan="5" style="font-size:11px;"><%#Eval("ProblemDescription")%></td></tr>
</tbody>
</table>
</ItemTemplate>
...
<td width="15%" style="font-size:11px;"><%#Eval("Name")%></td>
<td width="10%" style="font-size:11px;"><%#Eval("AvailableTime")%></td>
<td width="25%" align="center"><asp:Label ID="lbl_Status" runat="server" CssClass="lblg" Text=""><%#Eval("Status")%></asp:Label></td>
<td width="7%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Comment" CommandArgument='<%#Eval("TicketNo")%>'  OnClientClick= "return confirm('Are you Sure To Comment on Action?');"  ToolTip="To Initiate the Work"><i class="fa fa-commenting-o" style="font-size:X-large; color:Maroon;"></i></asp:LinkButton>
</td>
<td width="6%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton5" runat="server" CommandName="reAssign" CommandArgument='<%#Eval("TicketNo")%>'  OnClientClick= "return confirm('Are you Sure To Re-Assign to Others?');"  ToolTip="Re-Assign to Others"><i class="fa fa-link" style="font-size:X-large; color:Blue;"></i></asp:LinkButton>
</td>
...
<tr style="background:#EFFBFF;"><td width="100%" colspan="5" style="font-size:11px;"><%#Eval("ProblemDescription")%></td></tr>
</tbody>
</table>
</AlternatingItemTemplate>
</asp:Repeater>
