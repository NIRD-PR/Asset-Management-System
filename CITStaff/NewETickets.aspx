<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="CITStaff.master" AutoEventWireup="true" CodeFile="NewETickets.aspx.cs" Inherits="CITStaff_NewETickets" %>
...
<td width="10%" align="center" style="font-size:11px;"><%#Eval("Dated")%></td>
<td width="15%" align="center" style="font-size:11px;"><%#Eval("ItemName")%></td>
<td width="20%" style="font-size:11px;text-align:center;"><%#Eval("Name")%></td>
<td width="20%" style="font-size:11px;text-align:center;"><%#Eval("AvailableTime")%></td>
<td width="15%" align="center"><asp:Label ID="lbl_Status" runat="server" Text=""><%#Eval("Status")%></asp:Label></td>
<td width="5%" rowspan="2" class="actions" align='center'>
<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Initiate" CommandArgument='<%#Eval("TicketNo")%>' OnClientClick= "return confirm('Are you Sure To Initiate the Work?');"  ToolTip="To Initiate the Work"><i class="fa fa-thumbs-up" style="font-size:X-large; color:Green;"></i></asp:LinkButton>
</td>
</tr>
...
<tr style="background:#EFFBFF;"><td width="100%" colspan="6" style="font-size:11px;"><%#Eval("ProblemDescription")%></td></tr>
</tbody>
</table>
</AlternatingItemTemplate>
</asp:Repeater>
