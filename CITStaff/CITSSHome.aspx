<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="CITStaff.master" AutoEventWireup="true" CodeFile="CITSSHome.aspx.cs" Inherits="CITStaff_CITSSHome" %>
...
<div class="panel-heading"><h3 class="panel-title">CICT Engineer e-Tickets Dashboard &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lbl_Count" runat="server" CssClass="pull-right"></asp:Label></h3></div>
...
<tr><td colspan="5" align="center"><h5>Department wise CICT Engineer e-Tickets Status </h5></td></tr>
</table>
...
<th width="10%">Assigned / Not Yet Accepted</th>
<th width="10%">Accepted & In-Progress</th>
<th width="10%">Tickets on Hold</th>
<th width="10%">Closed Tickets</th>
<th width="20%">Total Tickets</th>
</tr>
</thead>
</table>
...
<td width="20%" align="center"><asp:Label ID="lbl_TotlTickets" runat="server"></asp:Label></td>
</tr>
</tbody>
</table>
</ItemTemplate>
...
<td width="20%" align="center"><asp:Label ID="lbl_gTotlTickets" runat="server"></asp:Label></td>
</tr>
</table>
</FooterTemplate>
</asp:Repeater>
