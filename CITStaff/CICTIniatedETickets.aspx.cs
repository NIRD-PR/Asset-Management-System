...
using System.Data;
public partial class CITStaff_IniatedETickets : System.Web.UI.Page
{
    ...
    protected void rptr_TicketData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("../CITSS_Cmts/{0}?st=" + e.CommandArgument.ToString());
        }
        ...
        if (e.CommandName == "reAssign")
        {
            ...
            objPRReq.Status = "Active";
            objPRReq.OID = oid;
            objPRReq.TicketNo = double.Parse(e.CommandArgument.ToString());
            objPRIBC.ResetCIT_eTicket_TicketNo(objPRReq);
            Response.Redirect("../CITSS_CP/{0}");
        }      
    }
