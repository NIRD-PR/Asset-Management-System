<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeFile="NewLogin.aspx.cs" Inherits="Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <div class="wrapper-page" onkeypress="return WebForm_FireDefaultButton(event, '<%= btn_Submit.ClientID %>')">
        ...
        <h3 class="text-center m-t-10 text-white" style="text-shadow: 1px 1px 2px black, 0 0 25px white, 0 0 5px yellow;">Sign In to <strong>NIRDPR</strong></h3></div>
        <div class="panel-body">
        <div class="form-horizontal m-t-20">
        <div class="form-group">
        <div class="col-xs-12" style="margin: 10px 0">
        <label>Select a role</label>
        <asp:DropDownList ID="ddl_roles" runat="server" CssClass="form-control"></asp:DropDownList></div>
        <div class="col-xs-12">
        ...
        <asp:TextBox ID="txt_Captcha" runat="server" CssClass="form-control"  placeholder="Captcha" onkeyup="ToUpper(this)"></asp:TextBox></div>
